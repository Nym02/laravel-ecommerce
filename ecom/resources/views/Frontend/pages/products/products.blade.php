                            ...
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="{{ route('ecom.productDetails', $ap->product_slug) }}">
                                                @foreach($ap->productImage as $productImg)
                                    ...
                                    <div class="product-info text-left">
                                        <h3 class="name"><a
                                                href="{{ route('ecom.productDetails', $ap->product_slug) }}">{{ $ap->product_title }}</a>
                                        </h3>
                                        <div class="rating rateit-small"></div>
                                        <div class="description"></div>
                                        <div class="product-price">
                                            @if(!is_null($ap->product_offer_price))
                                            <span class="price"><strong>BDT</strong> {{ $ap->product_offer_price }}
                                            </span>
                                            <span class="price-before-discount"><strong>BDT</strong>
                                                {{ $ap->product_price }} </span>
                                            @else
                                            <span class="price"><strong>BDT</strong> {{ $ap->product_price }} </span>
                                            @endif
                                        </div>
                                        ...
                                        <div class="action">
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="lnk"><a class="add-to-cart" href="detail.html"
                                                        title="Compare"> <i class="fa fa-signal"></i>
                                                    </a></li>
                                            </ul>
                                        </div>
                                        <!-- /.action -->
                            ...
                            <div class="product-list product">
                                <div class="row product-list-row">
                                    <div class="col col-sm-4 col-lg-4">
                                        <div class="product-image">
                                            <div class="image"><img
                                                    src="{{ asset('Frontend/assets/images/products/p3.jpg') }}" alt="">
                                            </div>
                                        </div>
                                        <!-- /.product-image -->
                                    </div>
                            ...
                            <div class="product-list product">
                                <div class="row product-list-row">
                                    <div class="col col-sm-4 col-lg-4">
                                        <div class="product-image">
                                            <div class="image"><img
                                                    src="{{ asset('Frontend/assets/images/products/p4.jpg') }}" alt="">
                                            </div>
                                        </div>
                                        <!-- /.product-image -->
                                    </div>
                            ...
                            <div class="product-list product">
                                <div class="row product-list-row">
                                    <div class="col col-sm-4 col-lg-4">
                                        <div class="product-image">
                                            <div class="image"><img
                                                    src="{{ asset('Frontend/assets/images/products/p5.jpg') }}" alt="">
                                            </div>
                                        </div>
                                        <!-- /.product-image -->
                                    </div>
                            ...
                            <div class="product-list product">
                                <div class="row product-list-row">
                                    <div class="col col-sm-4 col-lg-4">
                                        <div class="product-image">
                                            <div class="image"><img
                                                    src="{{ asset('Frontend/assets/images/products/p6.jpg') }}" alt="">
                                            </div>
                                        </div>
                                        <!-- /.product-image -->
                                    </div>
                            ...
                            <div class="product-list product">
                                <div class="row product-list-row">
                                    <div class="col col-sm-4 col-lg-4">
                                        <div class="product-image">
                                            <div class="image"><img
                                                    src="{{ asset('Frontend/assets/images/products/p7.jpg') }}" alt="">
                                            </div>
                                        </div>
                                        <!-- /.product-image -->
                                    </div>
                            ...
                            <div class="product-list product">
                                <div class="row product-list-row">
                                    <div class="col col-sm-4 col-lg-4">
                                        <div class="product-image">
                                            <div class="image"><img
                                                    src="{{ asset('Frontend/assets/images/products/p8.jpg') }}" alt="">
                                            </div>
                                        </div>
                                        <!-- /.product-image -->
                                    </div>
                            ...
                            <div class="product-list product">
                                <div class="row product-list-row">
                                    <div class="col col-sm-4 col-lg-4">
                                        <div class="product-image">
                                            <div class="image"><img
                                                    src="{{ asset('Frontend/assets/images/products/p9.jpg') }}" alt="">
                                            </div>
                                        </div>
                                        <!-- /.product-image -->
                                    </div>
                            ...
                            <div class="product-list product">
                                <div class="row product-list-row">
                                    <div class="col col-sm-4 col-lg-4">
                                        <div class="product-image">
                                            <div class="image"><img
                                                    src="{{ asset('Frontend/assets/images/products/p10.jpg') }}" alt="">
                                            </div>
                                        </div>
                                        <!-- /.product-image -->
                                    </div>
                            ...
                            <div class="product-list product">
                                <div class="row product-list-row">
                                    <div class="col col-sm-4 col-lg-4">
                                        <div class="product-image">
                                            <div class="image"><img
                                                    src="{{ asset('Frontend/assets/images/products/p11.jpg') }}" alt="">
                                            </div>
                                        </div>
                                        <!-- /.product-image -->
                                    </div>
                            ...
                            <div class="product-list product">
                                <div class="row product-list-row">
                                    <div class="col col-sm-4 col-lg-4">
                                        <div class="product-image">
                                            <div class="image"><img
                                                    src="{{ asset('Frontend/assets/images/products/p12.jpg') }}" alt="">
                                            </div>
                                        </div>
                                        <!-- /.product-image -->
                                    </div>
                            ...
                            <div class="product-list product">
                                <div class="row product-list-row">
                                    <div class="col col-sm-4 col-lg-4">
                                        <div class="product-image">
                                            <div class="image"><img
                                                    src="{{ asset('Frontend/assets/images/products/p13.jpg') }}" alt="">
                                            </div>
                                        </div>
                                        <!-- /.product-image -->
                                    </div>
