                                        ...
                                        <div class="single-product-gallery-item" id="slide8">
                                            <a data-lightbox="image-1" data-title="Gallery"
                                               href="{{ asset('Frontend/assets/images/products/p15.jpg') }}">
                                                <img class="img-responsive" alt="" src="{{ asset('Frontend/assets/images/blank.gif') }}"
                                                     data-echo="{{ asset('Frontend/assets/images/products/p15.jpg') }}"/>
                                            </a>
                                        </div><!-- /.single-product-gallery-item -->
                                        ...
                                        <div class="single-product-gallery-item" id="slide9">
                                            <a data-lightbox="image-1" data-title="Gallery"
                                               href="{{ asset('Frontend/assets/images/products/p16.jpg') }}">
                                                <img class="img-responsive" alt="" src="{{ asset('Frontend/assets/images/blank.gif') }}"
                                                     data-echo="{{ asset('Frontend/assets/images/products/p16.jpg') }}"/>
                                            </a>
                                        </div><!-- /.single-product-gallery-item -->
                                                ...
                                                <a class="horizontal-thumb active" data-target="#owl-single-product"
                                                   data-slide="1" href="#slide1">
                                                    <img class="img-responsive" width="85" alt=""
                                                         ...
                                                         data-echo="{{ asset('Frontend/assets/images/products/p17.jpg') }}"/>
                                                </a>
                                            </div>
                                                    ...
                                                    <div class="review">
                                                        <div class="review-title"><span
                                                                class="summary">We love this product</span><span class="date"><i
                                                                    class="fa fa-calendar"></i><span>1 days ago</span></span></div>
