                                ...
                                <div class="owl-item" style="width: 223px;">
                                    <div class="item">
                                        <div class="products">
                                            <div class="hot-deal-wrapper">
                                                <div class="image">
                                                    <img src="{{ asset('Frontend/assets/images/products/p6.jpg') }}"
                                                         alt="">
                                                </div>
                                                <div class="sale-offer-tag"><span>35%<br>off</span></div>
                                                <div class="timing-wrapper">
                                ...
                                <div class="owl-item" style="width: 223px;">
                                    <div class="item">
                                        <div class="products">
                                            <div class="hot-deal-wrapper">
                                                <div class="image">
                                                    <img src="{{ asset('Frontend/assets/images/products/p7.jpg') }}"
                                                         alt="">
                                                </div>
                                                <div class="sale-offer-tag"><span>35%<br>off</span></div>
                                                <div class="timing-wrapper">
                                    ...
                                    <div class="owl-wrapper"
                                        ...
                                        <div class="owl-item" style="width: 319px;">
                                            <div class="single-product-gallery-item" id="slide2">
                                                <a data-lightbox="image-1" data-title="Gallery"
                                                   href="{{ asset('Frontend/assets/images/products/p9.jpg') }}">
                                                    <img class="img-responsive" alt=""
                                        ...
                                        <div class="owl-item" style="width: 319px;">
                                            <div class="single-product-gallery-item" id="slide4">
                                                <a data-lightbox="image-1" data-title="Gallery"
                                                   href="{{ asset('Frontend/assets/images/products/p11.jpg') }}">
                                                    <img class="img-responsive" alt=""
                                        ...
                                        <div class="owl-item" style="width: 319px;">
                                            <div class="single-product-gallery-item" id="slide8">
                                                <a data-lightbox="image-1" data-title="Gallery"
                                                   href="{{ asset('Frontend/assets/images/products/p15.jpg') }}">
                                                    <img class="img-responsive" alt=""
                                        ...
                                        <div class="owl-item" style="width: 319px;">
                                            <div class="single-product-gallery-item" id="slide9">
                                                <a data-lightbox="image-1" data-title="Gallery"
                                                   href="{{ asset('Frontend/assets/images/products/p16.jpg') }}">
                                                    <img class="img-responsive" alt=""
                                        ...
                                        <div class="reviews">
                                            <div class="review">
                                                <div class="review-title"><span
                                                        class="summary">We love this product</span><span class="date"><i
                                            ...
                                            <div class="product-info text-left">
                                                ...
                                                <div class="rating rateit-small rateit">
                                                    ...
                                                    <div id="rateit-range-10" class="rateit-range" tabindex="0"
                                                         role="slider" aria-label="rating" aria-owns="rateit-reset-10"
                                                         aria-valuemin="0" aria-valuemax="5" aria-valuenow="4"
                                                         aria-readonly="true" style="width: 70px; height: 14px;">
                                                        <div class="rateit-selected"
                                                             style="height: 14px; width: 56px;"></div>
                                            ...
                                            <div class="product-info text-left">
                                                ...
                                                <div class="rating rateit-small rateit">
                                                    ...
                                                    <div id="rateit-range-11" class="rateit-range" tabindex="0"
                                                         role="slider" aria-label="rating" aria-owns="rateit-reset-11"
                                                         aria-valuemin="0" aria-valuemax="5" aria-valuenow="4"
                                                         aria-readonly="true" style="width: 70px; height: 14px;">
                                                        <div class="rateit-selected"
                                                             style="height: 14px; width: 56px;"></div>
