    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Create New District</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                            ...
                            <div class="card-body" style="display: block;">
                                <form action="{{ route('district.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputEmail1" name="districtName" aria-describedby="emailHelp" placeholder="Enter District Name">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary d-inline-block">Add District</button>
                                </form>
                            </div>
                            <!-- /.card-body -->
                        </div>
